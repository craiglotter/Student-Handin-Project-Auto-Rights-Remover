                                            ...
                                            If coursedir.Exists = True Then
                                                ...
                                                For Each projectdir In coursedir.GetDirectories
                                                    ...
                                                    If percentComplete > highestPercentageReached Then
                                                        ...
                                                        statusmessage = "Processing Folder Rights"
                                                    ...
                                                    If projectdir.Exists = True Then
                                                        ...
                                                        If accessgate = "open" Then
                                                            If File_Exists(projectdir.FullName & "\rights_added.prr") = False Then
                                                                dowork = True
                                                                Activity_Handler(projectdir.FullName & ": Access control is necessary")
                                                                statusresults = statusresults & (projectdir.Name & ": Access control is necessary").Trim.Trim.Replace(vbCrLf, " ") & vbCrLf
                                                            End If
                                                        Else
                                                            If File_Exists(projectdir.FullName & "\rights_removed.prr") = False Then
                                                                dowork = True
                                                                Activity_Handler(projectdir.FullName & ": Access control is necessary")
                                                                statusresults = statusresults & (projectdir.Name & ": Access control is necessary").Trim.Trim.Replace(vbCrLf, " ") & vbCrLf
                                                            End If
                                                        ...
                                                        If dowork = False Then
                                                            Activity_Handler(projectdir.FullName & ": Access control is unnecessary")
                                                            statusresults = statusresults & (projectdir.Name & ": Access control is unnecessary").Trim.Trim.Replace(vbCrLf, " ") & vbCrLf
                                                        End If
                                                        ...
                                                        If accessgate = "open" Then
                                                            If File_Exists(projectdir.FullName & "\rights_added.prr") = False Then
                                                                Dim writer As StreamWriter = New StreamWriter(projectdir.FullName & "\rights_added.prr", True)
                                                                writer.WriteLine("")
                                                                writer.Flush()
                                                                writer.Close()
                                                                writer = Nothing
                                                        ...
                                                        Else
                                                            If File_Exists(projectdir.FullName & "\rights_removed.prr") = False Then
                                                                Dim writer As StreamWriter = New StreamWriter(projectdir.FullName & "\rights_removed.prr", True)
                                                                writer.WriteLine("")
                                                                writer.Flush()
                                                                writer.Close()
                                                                writer = Nothing
